...
describe("testing isPaildrome", function(){
    
    test("should return true for a single letter", function(){
        expect(isPalindrome("a")).toBe(true);
    });

    test("should return for a single letter repeated", function(){
    ...
    test("should be true for a longer palindrome", function(){
        expect(isPalindrome("racecar")).toBe(true);
    });

    test("should return false for a longer non-palindrom", function(){
